...
public class Camera2BasicFragment extends Fragment
    ...
    // list of coaching gifs
    private static final ArrayList<String> INSTRUCTIONS = new ArrayList<>(Arrays.asList("back", "right","left"));
    private static int INSTRUCTIONS_IND = 0;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        Switch coachSwitch = (Switch) view.findViewById(R.id.switch_coach);
        coachSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                view.findViewById(R.id.gifImageView).setVisibility(isChecked?View.VISIBLE:View.INVISIBLE);
            }
        ...
        TimerTask timerTaskObj = new TimerTask() {
            public void run() {
                ...
                if (((Switch) view.findViewById(R.id.switch_coach)).isChecked()){
